          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-8 w-full rounded-md border border-border bg-background pl-9 pr-3 text-[13px] text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
              />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-8 w-full rounded-md border border-border bg-background pl-9 pr-3 text-[13px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
              />
            </div>
          </div>
